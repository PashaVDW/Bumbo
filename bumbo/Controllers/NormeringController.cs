    ...
    public class NormeringController : Controller
    {
        ...
        public IActionResult Index(string searchTerm, int page = 1)
        {
            ...
            var normeringen = new List<Normering>
            {
                ...
                new Normering { Week = "Week dd2", ColiUitladenMinuten = 6, VakkenVullenMinutenPerColi = 32, Kassa = "1 Kassière 25 klanten per uur", Vers = "1 medewerker per 80 klanten per uur", SpiegelenSecondenPerMeter = 35 },
                 new Normering { Week = "Week dd2", ColiUitladenMinuten = 6, VakkenVullenMinutenPerColi = 32, Kassa = "1 Kassière 25 klanten per uur", Vers = "1 medewerker per 80 klanten per uur", SpiegelenSecondenPerMeter = 35 },
                  new Normering { Week = "Week 2", ColiUitladenMinuten = 6, VakkenVullenMinutenPerColi = 32, Kassa = "1 Kassière 25 klanten per uur", Vers = "1 medewerker per 80 klanten per uur", SpiegelenSecondenPerMeter = 35 },
                   new Normering { Week = "Weekqqqwe 2", ColiUitladenMinuten = 6, VakkenVullenMinutenPerColi = 32, Kassa = "1 Kassière 25 klanten per uur", Vers = "1 medewerker per 80 klanten per uur", SpiegelenSecondenPerMeter = 35 },
                       new Normering { Week = "Week 1", ColiUitladenMinuten = 5, VakkenVullenMinutenPerColi = 30, Kassa = "1 Kassière 30 klanten per uur", Vers = "1 medewerker per 100 klanten per uur", SpiegelenSecondenPerMeter = 30 },
                new Normering { Week = "Week dd2", ColiUitladenMinuten = 6, VakkenVullenMinutenPerColi = 32, Kassa = "1 Kassière 25 klanten per uur", Vers = "1 medewerker per 80 klanten per uur", SpiegelenSecondenPerMeter = 35 },
                 new Normering { Week = "Week dd2", ColiUitladenMinuten = 6, VakkenVullenMinutenPerColi = 32, Kassa = "1 Kassière 25 klanten per uur", Vers = "1 medewerker per 80 klanten per uur", SpiegelenSecondenPerMeter = 35 },
                  new Normering { Week = "Week 2", ColiUitladenMinuten = 6, VakkenVullenMinutenPerColi = 32, Kassa = "1 Kassière 25 klanten per uur", Vers = "1 medewerker per 80 klanten per uur", SpiegelenSecondenPerMeter = 35 },
            ...
            var htmlTable = tableBuilder.GenerateTable("Normeringen", headers, normeringen, "../#add", item =>
            {
                return $@"
